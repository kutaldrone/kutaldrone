        ...
        <section ref={containerRef} className="relative h-[400vh] bg-[#020305]">
            <div className="sticky top-0 h-screen w-full overflow-hidden">
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center">
                    ...
                    <motion.div style={{ opacity: opacity1, scale: scale1, y: textY }} className="absolute text-center flex flex-col items-center gap-6 select-none">
                        {/* KUTAL DRONE TEXT */}
                        ...
                        <div className="flex gap-4 mt-12 pointer-events-auto">
                            <Link href="#contact">
                                <button className="bg-aerialix-dark text-[#c9fd74] px-8 py-4 rounded-full font-bold hover:scale-105 transition-transform flex items-center gap-2 border border-[#c9fd74]/20">
                                    Teklif Al
                                    <span className="bg-[#c9fd74] text-aerialix-dark p-1 rounded-full"><ArrowRight className="w-3 h-3" /></span>
                                </button>
                            </Link>
                            <Link href="#projects">
                                <button className="bg-white text-aerialix-dark px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-colors flex items-center gap-2">
                                    İşleri Gör
